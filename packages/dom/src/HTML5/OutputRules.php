...
/**
 * This is a modified version of masterminds/html5 OutputRules object.
 *
 * @internal
 */
class OutputRules implements RulesInterface
{
    ...
    protected function namespaceAttrs($ele)
    {
        if (!$this->xpath || $this->xpath->document !== $ele->ownerDocument) {
            $this->xpath = new XPath($ele->ownerDocument);
        }
    ...
    private function getXPath(Node $node)
    {
        if (!$this->xpath) {
     ...
     *
     * @see  http://www.w3.org/TR/2013/CR-html5-20130806/syntax.html#named-character-references True encoding will turn
     *       all named character references into their entities. This includes such characters as +.# and many other
     *       common ones. By default encoding here will just escape &'<>".
     *
