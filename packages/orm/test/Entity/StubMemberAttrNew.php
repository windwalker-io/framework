...
class StubMemberAttrNew implements EntityInterface
{
    use EntityTrait;
    ...
    #[ManyToMany(
        new MapBy(StubMemberActionMap::class, 'no', 'member_no', new MorphBy(type: 'student')),
        new TargetTo(StubActionAttrNew::class, 'action_no', 'no', new MorphBy(type: 'member')),
    )]
