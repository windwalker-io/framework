...
use Windwalker\ORM\Test\Entity\StubActionAttrNew;
use Windwalker\ORM\Test\Entity\StubMember;
use Windwalker\ORM\Test\Entity\StubMemberActionMap;
use Windwalker\ORM\Test\Entity\StubMemberAttrNew;

/**
 * The ManyMorphMany class.
 */
class ManyMorphManyAttrNewTest extends AbstractORMTestCase
{
    public function testLoad()
    {
        ...
        $mapTypes = $actions->all()
            ->map(fn(StubActionAttrNew $action) => $action->getMap()?->getType())
            ->unique()
            ->dump();
    ...
    public function testUpdateCascade()
    {
        ...
        self::assertEquals(
            ...
            $newMember->getActions()->all()
                ->map(fn(StubActionAttrNew $action) => $action->getMap()->getMemberNo())
                ->unique()
                ->values()
                ->dump()
        );
    ...
    public function testUpdateSetNull()
    {
        ...
        self::assertArraySimilar(
            $aids,
            self::$orm->mapper(StubActionAttrNew::class)
                ->select()
                ->where('id', $aids)
                ->loadColumn('id')
                ->dump()
    ...
    public function createMemberMapper(
        ...
        $mapper = self::$orm->mapper(StubMemberAttrNew::class);
    ...
    public function createActionMapper(
        ...
        $mapper = self::$orm->mapper(StubActionAttrNew::class);
