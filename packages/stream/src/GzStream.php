...
class GzStream extends Stream
{
    ...
    public function attach(mixed $stream, string $mode = 'r'): static
    {
        ...
        if (is_resource($stream)) {
            ...
            $this->resource = gzopen($stream, $mode);
        } elseif ($stream !== false) {
    ...
    {
        throw new \LogicException('GZStream dose not support getSize()');
    }
    ...
    public function seek($offset, $whence = SEEK_SET): bool
    {
        ...
        $result = gzseek($this->resource, $offset, $whence);
    ...
    public function write($string): int
    {
        ...
        $result = gzwrite($this->resource, $string);
    ...
    public function read($length): string
    {
        ...
        $result = gzread($this->resource, $length);
