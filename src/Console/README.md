...
Add `"windwalker/application": "~2.0-beta2"` to the require block in your composer.json,
make sure you have `"minimum-stability": "dev"` and then run composer install.

``` json
{
    "require": {
        "asika/windwalker-console": "~2.0-beta2"
    },
...
composer require asika/windwalker-console "~2.0-beta2"
```
