...
class PostgresqlTable extends AbstractTable
{
	...
	{
		$query = PostgresqlQueryBuilder::createTable($this->table, $columns, $pks, $keys, $autoIncrement, $ifNotExists, $engine, $defaultCharset);
	...
	public function addColumn($name, $type = 'text', $signed = true, $allowNull = true, $default = '', $comment = '', $options = array())
	{
		...
		// $query = PostgresqlQueryBuilder::addColumn($this->table, $name, $type, $unsigned, $notNull, $default, $position, $comment);
	...
	{
		$query = PostgresqlQueryBuilder::dropIndex($this->table, $type, $name);
	...
	{
		$query = PostgresqlQueryBuilder::showTableColumns($this->table, $full);
	...
	{
		$query = PostgresqlQueryBuilder::showTableColumns($this->table, $full, 'Field = ' . $this->db->quote($column));
