...
CONFIGFILE="$BASEDIR/apache/windwalker.host"
if [ "$3" ]
then
    CONFIGFILE="$3"
fi
...
sudo mv $VHOSTNAME /etc/apache2/sites-available/001-$VHOSTNAME.conf

# Must open permission of /home/travis
