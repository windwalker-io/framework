...
class StructureTest extends AbstractBaseTestCase
{
	...
	public function testLoadFile()
	{
		...
		$this->assertEquals($structure->reset()->loadFile(__DIR__ . '/Stubs/flower.json', 'json')->get('flower'), 'sakura');
		$this->assertEquals($structure->reset()->loadFile(__DIR__ . '/Stubs/flower.yml', 'yaml')->get('flower'), 'sakura');
		$this->assertEquals($structure->reset()->loadFile(__DIR__ . '/Stubs/flower.ini', 'ini')->get('flower'), 'sakura');
		$this->assertEquals($structure->reset()->loadFile(__DIR__ . '/Stubs/flower.xml', 'xml')->get('flower'), 'sakura');
		$this->assertEquals($structure->reset()->loadFile(__DIR__ . '/Stubs/flower.php', 'php')->get('flower'), 'sakura');
	}
	...
	public function testLoadString()
	{
		...
		$this->assertEquals($structure->reset()->loadString(file_get_contents(__DIR__ . '/Stubs/flower.json'), 'json')->get('flower'), 'sakura');
		$this->assertEquals($structure->reset()->loadString(file_get_contents(__DIR__ . '/Stubs/flower.yml'), 'yaml')->get('flower'), 'sakura');
		$this->assertEquals($structure->reset()->loadString(file_get_contents(__DIR__ . '/Stubs/flower.ini'), 'ini')->get('flower'), 'sakura');
		$this->assertEquals($structure->reset()->loadString(file_get_contents(__DIR__ . '/Stubs/flower.xml'), 'xml')->get('flower'), 'sakura');
	}
	...
	public function testMerge()
	{
		...
		$this->assertEquals('new bar value 2', $structure1->get('bar.bar2'), 'Line: ' . __LINE__ . '. bar.bar2 should be override.');
		...
		$structure = new Structure(array('flower' => 'rose', 'honor' => 'Osmanthus month'));
	...
	public function testMergeWithIgnoreValues()
	{
		...
		$structure1->setIgnoreValues(array(null, ''));
		$structure1->merge($structure2);
	...
	{
		$structure = new Structure(array('sunflower' => 'shine', 'honor' => 'Osmanthus month'));
	...
	public function testPush()
	{
		...
		$structure->set('foo', array('var1', 'var2', 'var3'));
		...
		$structure->setRaw('foo2', (object) array('var1', 'var2', 'var3'));
	...
	public function testShift()
	{
		...
		$structure->set('foo.bar', array('var1', 'var2', 'var3'));

		$this->assertEquals('var1', $structure->shift('foo.bar'));

		$this->assertEquals('var2', $structure->get('foo.bar.0'));

		$structure->setRaw('foo.bar2', (object) array('v1' => 'var1', 'v2' => 'var2', 'v3' => 'var3'));
